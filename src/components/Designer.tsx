export default function Designer() {
  return <p>Some Designs will come here</p>;
}




// the old code below may not be relevant for this project
...
//   "div",
//   tv({
//     base: "relative mb-2 h-8 w-8 cursor-pointer rounded-full border-2 opacity-100 transition-opacity border-green-700",
//   })
// );
